...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    if ($result->num_rows == 1) {
        ...
        if ($row && ($row['usertype'] === "Admin" || $row['usertype'] === "Admission"|| $row['usertype'] === "Developer"|| $row['usertype'] === "Registrar"|| $row['usertype'] === "Faculty Head"|| $row['usertype'] === "College Registrar")) {
