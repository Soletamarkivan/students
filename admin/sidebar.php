        ...
        <div id="sidebar" class="flex flex-col justify-between sidebar w-56 h-screen ease-linear duration-500 cursor-pointer sidebar-default" style="background-color: #4D81C8;">
            <div>
                ...
                <div>
                    ...
                    <?php if (hasAccess(['Faculty Head', 'Admin', 'Developer'], $usertype)) : ?>
                        <div x-data="{ facultyDropdownOpen: false }" @mouseenter="facultyDropdownOpen = true" @mouseleave="facultyDropdownOpen = false" class="ml-2 relative">
                            ...
                            <div x-show="facultyDropdownOpen" @click.away="facultyDropdownOpen = false" class="z-50 absolute top-0 left-full mt-0  w-48 bg-white border rounded shadow-lg">
                                <div class="py-2">
                                    <a href="../admin/facultyAdvisory.php" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Faculty List</a>
                                    <a href="assignfaculty.php" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Assign Faculty Subject</a>
                                    <a href="manageclass.php" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">Class List</a>
                    ...
                    <?php if (hasAccess(['Admin', 'Developer', 'Registrar'], $usertype)) : ?>
                        <div class="ml-2">
                    ...
                    <?php if (hasAccess(['Admin', 'College Registrar', 'Developer'], $usertype)) : ?>
                        <div class="ml-2">
