                            ...
                            <table class="table-auto border-separate">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pr-4">
                                            <div class="mx-auto text-sm text-center">
                                                <?= $student_details['elementary_year'] ?>
                                            </div>
                                        </td>
                                        <td class="pr-4">
                                            <div class="mx-auto text-sm text-center">
                                                <?= $student_details['elementary_name'] ?>
                                            </div>
                                        </td>
                                        <td class="pr-4">
                                            <div class="mx-auto text-sm">
                                                <?= $student_details['elementary_address'] ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="pr-4">
                                            <div class="mx-auto text-sm text-center">
                                                <?= $student_details['junior_high_year'] ?>
                                            </div>
                                        </td>
                                        <td class="pr-4 text-center">
                                            <div class="mx-auto text-sm">
                                                <?= $student_details['junior_high_name'] ?>
                                            </div>
                                        </td>
                                        <td class="pr-4">
                                            <div class="mx-auto text-sm">
                                                <?= $student_details['junior_high_address'] ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="pr-4">
                                            <div class="mx-auto text-sm text-center">
                                                <?= $student_details['senior_high_year'] ?>
                                            </div>
                                        </td>
                                        <td class="pr-4 text-center">
                                            <div class="mx-auto text-sm">
                                                <?= $student_details['senior_high_name'] ?>
                                            </div>
                                        </td>
                                        <td class="pr-4">
                                            <div class="mx-auto text-sm">
                                                <?= $student_details['senior_high_address'] ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="w-full mt-2">
                            ...
                            <div class="grid flex justify-end items-center">
                                <div class="text-center">
                                    <?php if (empty($student_details['e_sign'])): ?>
                                        <i>No signature</i>
                                    <?php else: ?>
                                        <?php
                                        $profilePicturePath = htmlspecialchars($student_details['e_sign']);
                                        $profilePicturePath = str_replace("../student/", "", $profilePicturePath);
                                        $fullImagePath = "../student/" . $profilePicturePath;
                                        ?>
                                        <img src="<?= $fullImagePath ?>" class="w-28" alt="">
                                    <?php endif; ?>
                                </div>
