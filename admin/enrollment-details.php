    ...
    <div class="mt-4">
        <div class="w-full bg-white p-4 border border-blue-100 gap-2 font-semibold">
            <div class="flex justify-between items-center gap-2">
                <div class="w-full flex justify-between items-center gap-2">
                    <div class="flex justify-start items-center gap-2">
                        <a href="./enrollment-list.php" aria-label="Go back" id="goBackButton">
                            <img src="../assets/svg/back.svg"
                                style="width: 24px; height: 24px; transition: width 0.3s, height 0.3s;" alt="Go back">
                        </a>
                        <div class="flex justify-start items-center gap-2">
                    ...
                    <div class="flex items-center gap-2">
                        <button onclick="location.href='edit-enrollment-details.php?student_id=<?= $student_id ?>'"
                            class="px-2 py-1 bg-yellow-300 rounded-md text-sm text-black hover:text-white hover:bg-yellow-500">
                            Edit
                        </button>
                        <button onClick="printStudentDetails();"
                            class="px-2 py-1 text-sm bg-blue-500 rounded-md  text-white hover:bg-blue-700">
                            Print
                        </button>
                    </div>
                </div>
            ...
            <div class="flex gap-4 mt-8" id='printable_div_id'>
                <div id="studentDetailsContainer" class="py-10 px-12 w-full">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span><?= $student_details['surname'] ?>, <?= $student_details['first_name'] ?>
                                        <?= $student_details['middle_name'] ?>.<?= $student_details['suffix'] ?></span>
                                </div>
                                <div class="flex items-center">
                                ...
                                <div class="flex items-center">
                                    <span class="font-bold text-gray-600">Uploaded file:</span>
                                    <a class="px-3 py-2 bg-blue-800 mx-3 text-white rounded" href="<?= isset($student_details['upload_file']) ? '../student/' . $student_details['upload_file'] : '#' ?>">View file</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex mt-4">
                            ...
                            <div class="w-1/2 pr-4">
                                <h3 class="text-lg font-bold flex items-center justify-between">First Semester -
                                    <?= $currentYear ?>
                                    <button
                                        onclick="location.href='registration-card.php?student_id=<?= $student_id ?>&semester=First Semester&year=<?= $currentYear ?>'"
                                        class="px-2 py-1  bg-green-300 rounded-md text-sm text-black hover:text-white hover:bg-green-500">
                                        Registration Card
                                    </button>
                                </h3>
                                <table class="table-auto w-full mt-2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="border px-2 py-1 text-sm"><?= $firstSemesterSubject['code'] ?>
                                            </td>
                                            <td class="border px-2 py-1 text-sm"><?= $firstSemesterSubject['name'] ?>
                                            </td>
                                            <td class="border px-2 py-1 text-sm text-center">
                                                <?= $firstSemesterSubject['unit'] ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                            ...
                            <div class="w-1/2 pl-4">
                                <h3 class="text-lg font-bold flex items-center justify-between">Second Semester -
                                    <?= $currentYear ?>
                                    <button
                                        onclick="location.href='registration-card.php?student_id=<?= $student_id ?>&semester=Second Semester&year=<?= $currentYear ?>'"
                                        class="px-2 py-1  bg-green-300 rounded-md text-sm text-black hover:text-white hover:bg-green-500">
                                        Registration Card
                                    </button>
                                </h3>
                                <table class="table-auto w-full mt-2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="border px-2 py-1 text-sm"><?= $secondSemesterSubject['code'] ?>
                                            </td>
                                            <td class="border px-2 py-1 text-sm"><?= $secondSemesterSubject['name'] ?>
                                            </td>
                                            <td class="border px-2 py-1 text-sm text-center">
                                                <?= $secondSemesterSubject['unit'] ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
