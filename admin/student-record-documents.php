    ...
    <div>
        ...
        <div id="content-section-1" class="content-section  w-full bg-white border border-blue-100 gap-2 font-semibold printable-area">
            <?php if (isset($student_details)) : ?>
                        ...
                        <table class="w-full ">
                            ...
                            <tbody>
                                ...
                                <div>
                                    ...
                                    mysqli_stmt_bind_result($stmt, $year_level, $semester, $code, $name, $unit, $prelim, $midterm, $finals, $total, $school_year);
                ...
                <td class='font-bold border-r border-black pl-3'>First Semester SY $school_year</td>
                <td class='border-r border-black'></td>
                <td class='border-r border-black'></td>
            </tr>";
            ...
            <td class='text-center'>$unit</td>
                                    ...
                                    $enrolledSubjectsQuery = "SELECT 
                                                                ...
                                                                WHERE student_number.student_number = ?
                                                                AND yl.year_level = 'First Year'
                                                                AND stbl.semester = 'Second Semester'";
                                    ...
                                    while (mysqli_stmt_fetch($stmt)) {
                                        if ($firstIteration) {
                                            ...
                                            echo "<tr>
                <td class='border-r border-black'></td>
                <td class='font-bold border-r border-black pl-3'>Second Semester SY $school_year</td>
                <td class='border-r border-black'></td>
                <td class='border-r border-black'></td>
            </tr>";
                                            $firstIteration = false;
                            ...
                            <table class="w-full" style="font-size: 11.5px;">
                                ...
                                <tbody>
                                    ...
                                    <div>
                                        ...
                                        mysqli_stmt_bind_result($stmt, $year_level, $semester, $code, $name, $unit, $legend, $prelim, $midterm, $finals, $total, $school_year);
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            if ($firstIteration) {
                                                echo
                                                "<tr class='border border-black'>
                                                    <td colspan='16' class='pl-3 font-semibold'>First Semester SY $school_year</td>
                                                </tr>";
                                                $firstIteration = false;
                                            }
                                            ...
                                            echo
                                            "<tr>
                                                <td class='pl-3 border-l  border-black'>$name</td>
                                                <td class='border border-black text-center'>$total</td>";


                                            for ($i = 1; $i <= 12; $i++) {
                                                echo "<td class='border border-black text-center' id='$i'>";
                                            ...
                                            <td class='border border-black text-center'>$unit</td>
                                        </tr>";
                                        }
                                    ...
                                    <div>
                                        ...
                                        while (mysqli_stmt_fetch($stmt)) {
                                            if ($firstIteration) {
                                                echo
                                                "<tr class='border border-black'>
                                                    <td colspan='16' class='pl-3 font-semibold'>Second Semester SY $school_year</td>
                                                </tr>";
                                                $firstIteration = false;
                                            }
...
enrolled_subjects.finals,
ROUND((sbj.unit + 
    (enrolled_subjects.prelim + enrolled_subjects.midterm + enrolled_subjects.finals) / 3), 2) as total,
enrolled_subjects.school_year
FROM 
students
JOIN enrolled_subjects ON students.student_id = enrolled_subjects.student_id
...
JOIN semester_tbl stbl ON enrolled_subjects.semester_tbl_id = stbl.semester_tbl_id
WHERE student_number.student_number = ?
AND yl.year_level IN ('First Year', 'Second Year', 'Third Year', 'Fourth Year')
AND stbl.semester IN ('First Semester', 'Second Semester')";
...
// Initialize total units variable
$totalUnits = 0;
...
while (mysqli_stmt_fetch($stmt)) {
    // Your existing code for displaying enrolled subjects

    // Add the unit to the total
    $totalUnits += $unit;
}

echo '</div>';

// Display the total units row
