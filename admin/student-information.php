...
<body class="font-[roboto-serif]">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    <form action="" method="get" id="filterForm" class="flex items-center gap-2">
                                        ...
                                        <select name="status" id="status" class="p-1 border border-blue-200 rounded-md">
                                            ...
                                            <?php
                                            $status = ["Pre-registered", "Registered", "Officially Enrolled", "Not Enrolled"];
                        ...
                        <div class="border-l-2 border-blue-300">
                            <div id="tabsContainer" class="pl-2 h-full">
                                ...
                                <div class="h-1/2">
                                    ...
                                    <div id="notificationTabContent" class="tab-content p-1">   
                                    </div>
                                    <div id="requestsTabContent" class="tab-content">
                                                    ...
                                                    <div class="flex items-end justify-start">
                                                        <div>
                                                            ...
                                                            <div class="text-sm font-medium mb-1.5">
                                                                <p>Message: <span class="ml-1 font-normal"><?= $requestMessage['message']; ?></span></p>
                                                            </div>
                                                        ...
                                                        <button class="p-2 bg-blue-500 rounded-md text-xs text-white hover:bg-blue-700 done-button"
                                                                data-request-id="<?= $requestMessage['id']; ?>">
                                                            Done
                                                        </button>
                                                    </div>
                                                    <div id="updateMessage" class="text-blue-500 mt-2"></div>
                                                </div>
                                            <?php endforeach; ?>
                                        <?php else : ?>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        doneButtons.forEach(function (button) {
            button.addEventListener('click', function () {
                ...
                xhr.onreadystatechange = function () {
                    if (xhr.readyState === 4) {
                        if (xhr.status === 200) {
                            showUpdateMessage('Done updating student\'s details');

                            location.reload();
                        } else {
                            showUpdateMessage('Error updating student\'s details', true);
                        }
                    }
                };
                xhr.send('id=' + encodeURIComponent(requestId));
            });
        });
        ...
        function showUpdateMessage(message, isError = false) {
            ...
            updateMessage.style.color = isError ? 'red' : 'green';
