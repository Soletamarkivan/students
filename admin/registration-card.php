...
if (isset($_GET['student_id']) && isset($_GET['semester']) && isset($_GET['year'])) {
    ...
    if ($stmt) {
        ...
        if ($result) {
            ...
            if ($enrolled_subjects_stmt) {
                mysqli_stmt_bind_param($enrolled_subjects_stmt, "sss", $student_id, $semester, $year);
    ...
    // Handle the case where either student_id, semester, or year is not provided in the URL.
