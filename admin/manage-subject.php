                            ...
                            <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <div class="flex justify-between mb-2">
                                            <div>First Semester</div>
                                            <div class="flex justify-center">
                                                <button onclick="location.href='./bsem-fourth-year-first-semester.php'" class="p-2 bg-blue-100 rounded-md text-xs text-black hover:text-white hover:bg-blue-600">
                                                    Add Subject
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div class="flex justify-between mb-2">
                                            <div>Second Semester</div>
                                            <div class="flex justify-center">
                                                <button onclick="location.href='./bsem-fourth-year-second-semester.php'" class="p-2 bg-blue-100 rounded-md text-xs text-black hover:text-white hover:bg-blue-600">
                                                    Add Subject
                                                </button>
                                            </div>
                                        </div>
