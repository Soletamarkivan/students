...
$query = "SELECT * FROM student_notifications ORDER BY datetime DESC";  // Order by datetime in descending order
...
<body>
    <div>
        <div id="notifications-container" class="bg-white shadow-lg hidden fixed max-h-3/4 overflow-y-scroll top-16 right-80 max-w-sm p-4 rounded-md border border-blue-300">
