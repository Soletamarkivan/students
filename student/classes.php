...
$sql = "SELECT st.first_name, st.surname, st.middle_name, st.suffix, si.status, ed.course_id, si.profile_picture
                    ...
                    <?php else : ?>
                        <ul>
                            <?php foreach ($subjects as $subject) : ?>
                                <li>
                                    <strong>Subject Name:</strong> <?php echo htmlspecialchars($subject['name'], ENT_QUOTES, 'UTF-8'); ?><br>
                                    <strong>Subject Unit:</strong> <?php echo htmlspecialchars($subject['unit'], ENT_QUOTES, 'UTF-8'); ?><br>
